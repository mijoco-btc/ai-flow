...
if [ "$#" -ne 9 ]; then
    echo "Usage: $0 <project_name> <repo_url> <replacement_string1> <replacement_string2> <replacement_string3> <replacement_string4> <replacement_string5> <replacement_string6> <replacement_string7>"
    exit 1
fi
...
#clarinet deployments generate --no-dashboard --devnet
clarinet deployments apply --no-dashboard --devnet  < $SCRIPT_DIR/input_file
