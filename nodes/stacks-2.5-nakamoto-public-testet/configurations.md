---
description: Reference for configs for build instructions for cut and paste
---

# Configurations

Note some config details will be tailored to specific software versions.

### Nakamoto

* [Base config from docs](https://docs.stacks.co/nakamoto-upgrade/signing-and-stacking/sample-configuration-files)

stacks blockchain api

```
GIT_TAG=v7.10.0-nakamoto.2
NODE_ENV=production
PG_HOST=localhost
PG_PORT=5432
PG_USER=postgres
...
STACKS_CHAIN_ID=0x2147483648
#STACKS_CHAIN_ID=0x80000000
V2_POX_MIN_AMOUNT_USTX=90000000260
STACKS_CORE_EVENT_PORT=3700
STACKS_CORE_EVENT_HOST=localhost
...
db_path = "/mnt/nakamoto-testnet/signer.sqlite"
...
# previous step.
stacks_private_key = "<your signer private key>"
```
...
local_peer_seed = "F1222C5989BAC642B56550858D410CAAA0B9CFDF03E464C54DB0E392B25C1620" # Change to any 64-character hexidecimal string
...
working_dir = "/mnt/nakamoto-testnet" # Change to data directory you would like to use for your node
...
[[events_observer]]
endpoint = "localhost:30000" # change to your signer endpoint
retry_count = 255
